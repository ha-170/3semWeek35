...
private static final Gson GSON = new GsonBuilder().setPrettyPrinting().create();
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Salaries above 10000: " + result);
            ...
            System.out.println("Highest salary is: " + result3);
            ...
            System.out.println("The first names are: " + result4);
           
            //5) Create a query to calculate the number of employees and print the number
            Query query5 = em.createQuery("Select e.firstName FROM Employee e");
            List<Object[]> result5 = query5.getResultList();
            System.out.println("There are " + result5.size() + " number of employees");
            ...
            Query query7 = em.createQuery("Select e.id, e.firstName, e.lastName, e.salary FROM Employee e where e.salary = :salary");
            query7.setParameter("salary", result6);
            List<Object[]> result7 = query7.getResultList();
            System.out.println("The employee with the highest salary is: " + GSON.toJson(result7));
